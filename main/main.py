...
from src.financial import open_csv_data
from src.financial import open_excel_data
...
def get_transactions(user_input: str) -> Any:
    ...
    if user_input == "1":
        ...
        transactions = open_csv_data("../data/transactions.csv")
        return transactions
    elif user_input == "3":
        transactions = open_excel_data("../data/transactions_excel.xlsx")
        return transactions
